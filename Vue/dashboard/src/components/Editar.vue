	...
	<div class="container-fluid">
		<div class="row">
	        <main role="main" class="col-md-12 ml-sm-auto px-4">
				...
				<div id="notshow" class="row" style="display:none;"><div id="apper_show_not_doc" class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center"><h1 class="display-4">Você não escolheu um leilão!</h1><p class="lead">Escolha um leilão para poder editar.</p></div></div>
				<div id="show" class="row" style="display:none;">
	                <div class="container">
				      <div class="py-5 text-center">
				        <img class="d-block mx-auto" src="/assets/kin-network.png" width="180" height="180">
				        <h2>Editando um Leilão</h2>
					</div>
				      ...
				      <div class="row">
				          ...
				          <div class="needs-validation">
							...
							<div class="mb-3">
								<label>Escolha a Modalidade</label>
				              	<select class="form-control" id="modalidade">
				                	...
				                	<option value="2">Venda Online e Presencial</option>
									<option value="3">Somente Online</option>
								</select>
				            </div>
							...
							<hr class="space">
				            <button class="btn btn-primary btn-lg btn-block status" id="attmodalidade1" style="display:none;">Atualizar Leilão</button>
							<button class="btn btn-primary btn-lg btn-block status" id="attmodalidade2" style="display:none;">Atualizar Leilão</button>
							<button class="btn btn-primary btn-lg btn-block status" id="attmodalidade3" style="display:none;">Atualizar Leilão</button>
				          </div>
				        </div>
						</div>
